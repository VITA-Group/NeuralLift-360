...
class StableDiffusion(nn.Module):
    def __init__(self, device):
        ...
        self.vae = AutoencoderKL.from_pretrained(sd_name, subfolder="vae", use_auth_token=self.token).to(self.device)
        ...
        self.unet = UNet2DConditionModel.from_pretrained(sd_name, subfolder="unet", use_auth_token=self.token).to(self.device)
